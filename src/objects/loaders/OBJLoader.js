...
const _object_pattern = /^[og]\s*(.+)?/; // o or g declaration
...
function ParserState() {
  const state = {
    ...
    startObject: function (name, fromDeclaration) {
      // Use the initial (default) object if it hasn't been declared.
      ...
      this.object = {
        ...
        startMaterial: function (name, libraries) {
          ...
          // If the previous material was inherited or had no faces then remove it.
        ...
        _finalize: function (end) {
          ...
          // If ending and there are unused material groups, remove them.
      ...
      // Inherit the previous object's material if possible.
      if (
        previousMaterial &&
...
class OBJLoader extends Loader {
  ...
  parse(text) {
    ...
    if (hasPrimitives === true) {
      ...
      // If there are no face definitions, interpret the data as a point cloud.
